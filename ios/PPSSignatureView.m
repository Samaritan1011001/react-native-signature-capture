...
static GLKVector3 StrokeColor = { 255, 255, 255,1.0 };
...
- (void)commonInit {
	...
	if (context) {
		...
		self.backgroundColor = [UIColor colorWithRed:35/255.f green:46/255.f blue:61/255.f alpha:1.f];
		self.opaque = NO;
...
- (void)updateStrokeColor {
	...
	} else effect.constantColor = GLKVector4Make(255,255,255,1);
}
